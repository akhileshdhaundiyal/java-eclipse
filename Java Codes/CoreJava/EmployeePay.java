...
class Developer extends Employee
{
	...
	Developer(String str, double sal, String addr, String dept) 
	{
        	super(str, sal, addr);
	        department = dept;
	}
	...
	double totalPay() 
	{
             ...
             double houseRentAllowance = (basic * 0.05);
             double dearnessAllowance = (basic * 0.15);
...
class Manager extends Employee {
     ...
     * @param sal pased to the constructor
     * @param addr passed to the constructor
     * @param dept passed to the constructor
     */
...
class Director extends Employee {
     ...
     * @param addr passed to the constructor
     * @param dept passed to the constructor
     * @param allowance passed to the constructor
     */
...
class EmployeePay {
    ...
    public static void main(String[] args) {
       ...
       Developer devObj = new Developer("DevPandey", 2400.00, "London", "Developer");
       payTotal = devObj.totalPay();
       less = devObj.deduction(5);
       netPay = payTotal - less;
       System.out.println("\n\nDeveloper Details");
       System.out.println("============================");
       devObj.show();
